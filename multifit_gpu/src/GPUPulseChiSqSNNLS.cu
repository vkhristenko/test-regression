//#define GPUPulseChiSqSNNLS_cxx
#include "multifit_gpu/interface/GPUPulseChiSqSNNLS.h"
#include <math.h>
#include <iostream>


GPUPulseChiSqSNNLS::GPUPulseChiSqSNNLS() :
_chisq(0.),
_computeErrors(true)
{
...
__device__ bool GPUPulseChiSqSNNLS::DoFitGPU(DoFitArgs* parameters){
...
bool GPUPulseChiSqSNNLS::DoFit(const SampleVector &samples, const SampleMatrix &samplecor, double pederr, 
...
bool GPUPulseChiSqSNNLS::Minimize(const SampleMatrix &samplecor, double pederr, const FullSampleMatrix &fullpulsecov) {
...
//     std::cout << " iter =  " << iter << " :: " << maxiter << std::endl;
    ...
    if (iter>=maxiter) {
      //      edm::LogWarning("GPUPulseChiSqSNNLS::Minimize") << "Max Iterations reached at iter " << iter <<  std::endl;
...
bool GPUPulseChiSqSNNLS::updateCov(const SampleMatrix &samplecor, double pederr, const FullSampleMatrix &fullpulsecov) {
...
double GPUPulseChiSqSNNLS::ComputeChiSq() {
...
double GPUPulseChiSqSNNLS::ComputeApproxUncertainty(unsigned int ipulse) {
