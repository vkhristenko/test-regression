...
class PulseChiSqSNNLS {
 public:
  ...
  __host__ __device__ bool DoFit(const SampleVector& samples,
  ...
  __host__ __device__ const SamplePulseMatrix& pulsemat() const {
    return _pulsemat;
  }
 ...
 protected:
  __host__ __device__ bool Minimize(const SampleMatrix& samplecor,
                                    double pederr,
                                    const FullSampleMatrix& fullpulsecov);
  __host__ __device__ bool NNLS();
  __host__ __device__ bool updateCov(const SampleMatrix& samplecor,
                                     double pederr,
                                     const FullSampleMatrix& fullpulsecov);
...
__global__ void kernel_multifit(DoFitArgs* parameters,
                                Output* results,
                                unsigned int n);
